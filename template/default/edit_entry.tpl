<table width="100%" border="0" cellspacing="0" cellpadding="2">
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td class="boxtop"><font class="navfont">Edit Entry</font></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    ...
    <form action="?s=list&e={V}" method="post" name="post"><table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr>
    <td width="11%"><font class="normfont">Title:</font></td>
    <td width="89%"><input name="title" type="text" class="formcss" size="40" maxlength="40" value="{TITLE}" /></td>
  </tr>
  <tr>
    <td><font class="normfont">Tags:</font></td>
    <td><input name="tags" type="text" class="formcss" size="40" maxlength="40" value="{TAGS}" /></td>
  </tr>
  <tr>
...
{SNIPPET}</textarea></td>
  ...
  <tr>
    <td colspan="2"><textarea name="message" id="message" rows="10" cols="40" style="width: 100%; height: 50" class="formcss">{MESSAGE}</textarea></td>
  </tr>
  <tr>
    <td colspan="2"><div align="center"><input type="submit" name="Edit"  value="Edit" /></div></td>
  </tr>
    </table>
</form>
